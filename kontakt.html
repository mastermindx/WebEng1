...
<html lang="de" xmlns="http://www.w3.org/1999/xhtml" xml:lang="de">
  ...
  <body>
    ...
    <div class="container">
      ...
      <!-- Inhalt -->
      <div>
        <h2>Kontaktdaten und Impressum</h2>
        <h4>Da es sich hier um ein Abschlussprojekt handelt, welches nur für den MOOC erstellt wurde, werden keine reale Postadressen verwendet!</h4><br />
		<h5><b>Angaben gemäß § 5 TMG:</b></h5><br/><br/>
		<p>Marcel Vanderschaeghe<br />
		   Musterweg 10<br />
		...
		<p> </p>
		<p><i>Quellenangaben: <a rel="nofollow" href="http://www.e-recht24.de/muster-disclaimer.html" onclick="window.open(this.href);return false;">Disclaimer eRecht24</a></i></p>
	  </div>
